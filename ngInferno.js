...
(function (root, factory) {
  ...
  function renderComponent(component, props, scope, elem) {
    scope.$evalAsync(function() {
      Inferno.render(Inferno.createElement(component, props), elem[0]);
    });
  }
      ...
      link: function(scope, elem, attrs) {
        ...
        scope.$on('$destroy', function() {
          if (!attrs.onScopeDestroy) {
            Inferno.unmountComponentAtNode(elem[0]);
          } else {
            scope.$eval(attrs.onScopeDestroy, {
              unmountComponent: Inferno.unmountComponentAtNode.bind(this, elem[0])
            });
          }
        });
      }
